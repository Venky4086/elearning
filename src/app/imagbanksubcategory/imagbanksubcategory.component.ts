...
@Component({
  selector: 'app-imagbanksubcategory',
  templateUrl: './imagbanksubcategory.component.html',
  styleUrls: ['./imagbanksubcategory.component.css']
})
export class ImagbanksubcategoryComponent implements OnInit {
  ...
  getallcategorys(){
    this.spinner.show();
    this.elearningservice.img_bank_category_list().subscribe((res)=>{
      if(res){
        this.spinner.hide();
        console.log(res);
...
// add subcategories
  addsubcategory(){
    ...
    if(this.Addsubcategory.invalid){
      ...
      console.log(data);
      this.elearningservice.add_img_bank_subcategory(data).subscribe((res)=>{
        if(res){
        console.log(res);
  ...
  updatesubcategory(){
    ...
    if(this.Updatesubcategory.invalid){
      ...
      console.log(data);
      this.elearningservice.update_img_bank_subcategory(this.subcategory_id,data).subscribe((res)=>{
        if(res){
        console.log(res);
  ...
  deletesubcategory(){
    this.elearningservice.delete_diff_subcategory(this.subcategory_id).subscribe((res)=>{
      console.log(res);
