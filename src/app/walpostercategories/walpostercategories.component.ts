...
@Component({
  selector: 'app-walpostercategories',
  templateUrl: './walpostercategories.component.html',
  styleUrls: ['./walpostercategories.component.css']
})
export class WalpostercategoriesComponent implements OnInit {
...
//  add category
  ...
  addcategory(){
    ...
    this.elearningservice.add_wallposter_category(formData).subscribe((res)=>{
     console.log(res);
  ...
  updatecategory(){
     ...
     if(this.UpdateCategory.invalid){
      ...
      const data = {
       ...
       this.elearningservice.update_wallposter_category(this.category_id,data).subscribe((res)=>{
         if(res){
          console.log(res)
...
// delete category
  ...
  deletecategory(){
    this.elearningservice.delete_wallposter_category(this.categroy_id).subscribe((res)=>{
      console.log(res)
