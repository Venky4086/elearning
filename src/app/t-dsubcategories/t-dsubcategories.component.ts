...
@Component({
  selector: 'app-t-dsubcategories',
  templateUrl: './t-dsubcategories.component.html',
  styleUrls: ['./t-dsubcategories.component.css']
})
export class TDsubcategoriesComponent implements OnInit {
  ...
  subcategory_id: any;
  constructor(private testdiscussionservice:TestdiscussionService,private spinner: NgxSpinnerService,private fb:FormBuilder,private toastr: ToastrService,private elearningservice:ElearningService) {
   }
  ...
  getallcategorys(){
    this.spinner.show();
    this.testdiscussionservice.td_category_list().subscribe((res)=>{
      if(res){
        this.spinner.hide();
        console.log(res);
  ...
  getallsubcategory(){
    this.spinner.show();
    this.testdiscussionservice.td_subcategory_list().subscribe((res)=>{
     if(res){
      this.spinner.hide();
      console.log(res);
...
// add subcategories
  addsubcategory(){
    ...
    if(this.Addsubcategory.invalid){
      ...
      console.log(data);
      this.testdiscussionservice.add_td_subcategory(data).subscribe((res)=>{
        if(res){
        console.log(res);
  ...
  updatesubcategory(){
    ...
    if(this.Updatesubcategory.invalid){
      ...
      console.log(data);
      this.testdiscussionservice.update_td_subcategory(this.subcategory_id,data).subscribe((res)=>{
        if(res){
        console.log(res);
  ...
  deletesubcategory(){
    this.testdiscussionservice.delete_td_subcategory(this.subcategory_id).subscribe((res)=>{
      console.log(res);
