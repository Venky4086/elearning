...
@Component({
  selector: 'app-previous-qpaperssubcategory',
  templateUrl: './previous-qpaperssubcategory.component.html',
  styleUrls: ['./previous-qpaperssubcategory.component.css']
})
export class PreviousQpaperssubcategoryComponent implements OnInit {
  ...
  subcategory_id: any;
  constructor(private questionservice:QuestionService,private spinner: NgxSpinnerService,private fb:FormBuilder,private toastr: ToastrService,private elearningservice:ElearningService) {
   }
  ...
  getallcategorys(){
    // this.spinner.show();
    this.questionservice.list_previous_qpaper_category().subscribe((res)=>{
      if(res){
        // this.spinner.hide();
        console.log(res);
...
// add subcategories
  addsubcategory(){
    ...
    if(this.Addsubcategory.invalid){
      ...
      console.log(data);
      this.questionservice.add_previous_qpaper_subcategory(data).subscribe((res)=>{
        if(res){
        console.log(res);
  ...
  updatesubcategory(){
    ...
    if(this.Updatesubcategory.invalid){
      ...
      console.log(data);
      this.questionservice.update_previous_qpaper_subcategory(this.subcategory_id,data).subscribe((res)=>{
        if(res){
        console.log(res);
  ...
  deletesubcategory(){
    this.questionservice.delete_previous_qpaper_subcategory(this.subcategory_id).subscribe((res)=>{
      console.log(res);
