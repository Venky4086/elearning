...
@Component({
  selector: 'app-recentsubcategories',
  templateUrl: './recentsubcategories.component.html',
  styleUrls: ['./recentsubcategories.component.css']
})
export class RecentsubcategoriesComponent implements OnInit {
  ...
  getallcategorys(){
    this.spinner.show();
    this.elearningservice.recent_update_category_list().subscribe((res)=>{
      if(res){
        this.spinner.hide();
        console.log(res);
...
// add subcategories
  ...
  addsubcategory(){
    ...
    if(this.Addsubcategory.invalid){
      ...
      console.log(data);
      this.elearningservice.add_recent_update_subcategory(data).subscribe((res)=>{
        if(res){
        console.log(res);
  ...
  updatesubcategory(){
    ...
    if(this.Updatesubcategory.invalid){
      ...
      console.log(data);
      this.elearningservice.update_recent_update_category(this.subcategory_id,data).subscribe((res)=>{
        if(res){
        console.log(res);
        this.toastr.success(this.message,'Successfully subcategory updated',{
          positionClass: 'toast-top-center'
        });
        this.getallsubcategory();
  ...
  deletesubcategory(){
    this.elearningservice.delete_recent_update_subcategory(this.subcategory_id).subscribe((res)=>{
      console.log(res);
      this.toastr.success(this.message,'Successfully subcategory deleted',{
        positionClass: 'toast-top-center'
      });
      this.getallsubcategory();
      $('#deletesubcategory').hide();
