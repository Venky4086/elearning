...
@Component({
  selector: 'app-icardssubcategories',
  templateUrl: './icardssubcategories.component.html',
  styleUrls: ['./icardssubcategories.component.css']
})
export class IcardssubcategoriesComponent implements OnInit {
  ...
  getallcategorys(){
    // this.spinner.show();
    this.elearningservice.icard_category_list().subscribe((res)=>{
      if(res){
        // this.spinner.hide();
        console.log(res);
  ...
  getallsubcategory(){
    this.spinner.show();
    this.elearningservice.icard_subcategory_list().subscribe((res)=>{
     if(res){
      console.log(res);
...
// add subcategories
  addsubcategory(){
    ...
    if(this.Addsubcategory.invalid){
      ...
      console.log(data);
      this.elearningservice.add_icard_subcategory(data).subscribe((res)=>{
        if(res){
        console.log(res);
  ...
  updatesubcategory(){
    ...
    if(this.Updatesubcategory.invalid){
      ...
      console.log(data);
      this.elearningservice.update_icard_subcategory(this.subcategory_id,data).subscribe((res)=>{
        if(res){
        console.log(res);
  ...
  deletesubcategory(){
    this.elearningservice.delete_icard_subcategory(this.subcategory_id).subscribe((res)=>{
      console.log(res);
