...
@Component({
  selector: 'app-liveclasssubcategory',
  templateUrl: './liveclasssubcategory.component.html',
  styleUrls: ['./liveclasssubcategory.component.css']
})
export class LiveclasssubcategoryComponent implements OnInit {
  ...
  getallcategorys(){
    // this.spinner.show();
    this.questionserveice.list_liveclass_category().subscribe((res)=>{
      if(res){
        // this.spinner.hide();
        console.log(res);
  ...
  getallsubcategory(){
    this.spinner.show();
    this.questionserveice.list_liveclass_subcategory().subscribe((res)=>{
     if(res){
      this.spinner.hide();
      console.log(res);
...
// add subcategories
  addsubcategory(){
    ...
    if(this.Addsubcategory.invalid){
      ...
      console.log(data);
      this.questionserveice.add_liveclass_subcategory(data).subscribe((res)=>{
        if(res){
        console.log(res);
  ...
  updatesubcategory(){
    ...
    if(this.Updatesubcategory.invalid){
      ...
      console.log(data);
      this.questionserveice.update_liveclass_subcategory(this.subcategory_id,data).subscribe((res)=>{
        if(res){
        console.log(res);
  ...
  deletesubcategory(){
    this.questionserveice.delete_liveclass_subcategory(this.subcategory_id).subscribe((res)=>{
      console.log(res);
