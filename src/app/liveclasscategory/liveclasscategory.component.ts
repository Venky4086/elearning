...
declare var $: any;
@Component({
  selector: 'app-liveclasscategory',
  templateUrl: './liveclasscategory.component.html',
  styleUrls: ['./liveclasscategory.component.css']
})
export class LiveclasscategoryComponent implements OnInit {
  ...
  getallcategories(){
    this.spinner.show();
    this.questionservice.list_liveclass_category().subscribe((res)=>{
        if(res){
          this.spinner.hide();
          console.log(res);
...
//  add category
  ...
  addcategory(){
    ...
    this.questionservice.add_liveclass_category(formData).subscribe((res)=>{
     console.log(res);
  ...
  updatecategory(){
     ...
     if(this.UpdateCategory.invalid){
      ...
      const data = {
       ...
       this.questionservice.update_liveclass_category(this.category_id,data).subscribe((res)=>{
         if(res){
          console.log(res)
...
// delete category
  ...
  deletecategory(){
    this.questionservice.delete_liveclass_category(this.categroy_id).subscribe((res)=>{
      console.log(res)
