...
@Component({
  selector: 'app-pastexamsubcategories',
  templateUrl: './pastexamsubcategories.component.html',
  styleUrls: ['./pastexamsubcategories.component.css']
})
export class PastexamsubcategoriesComponent implements OnInit {
  ...
  getallcategorys(){
    // this.spinner.show();
    this.elearningservice.pastpaper_category_list().subscribe((res)=>{
      if(res){
        // this.spinner.hide();
        console.log(res);
...
// add subcategories
  addsubcategory(){
    ...
    if(this.Addsubcategory.invalid){
      ...
      console.log(data);
      this.elearningservice.add_pastpaper_subcategory(data).subscribe((res)=>{
        if(res){
        console.log(res);
  ...
  updatesubcategory(){
    ...
    if(this.Updatesubcategory.invalid){
      ...
      console.log(data);
      this.elearningservice.update_pastpaper_subcategory(this.subcategory_id,data).subscribe((res)=>{
        if(res){
        console.log(res);
  ...
  deletesubcategory(){
    this.elearningservice.delete_pastpaper_subcategory(this.subcategory_id).subscribe((res)=>{
      console.log(res);
