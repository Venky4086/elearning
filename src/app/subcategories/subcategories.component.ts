...
export class SubcategoriesComponent implements OnInit {
  ...
  getallcategorys(){
    this.spinner.show();
    this.elearningservice.diff_category_list().subscribe((res)=>{
      if(res){
        this.spinner.hide();
        console.log(res);
...
// add subcategories
  addsubcategory(){
    ...
    if(this.Addsubcategory.invalid){
      ...
      console.log(data);
      this.elearningservice.add_diff_subcategory(data).subscribe((res)=>{
        if(res){
        console.log(res);
  ...
  updatesubcategory(){
    ...
    if(this.Updatesubcategory.invalid){
      ...
      console.log(data);
      this.elearningservice.update_diff_subcategory(this.subcategory_id,data).subscribe((res)=>{
        if(res){
        console.log(res);
