...
@Component({
  selector: 'app-primecategory',
  templateUrl: './primecategory.component.html',
  styleUrls: ['./primecategory.component.css']
})
export class PrimecategoryComponent implements OnInit {
  submitted = false;
  category_name:any;
  category_image:any;
  message:any;
  ...
  constructor(private questionserveice:QuestionService,private spinner: NgxSpinnerService,private http:HttpClient,private fb:FormBuilder,private toastr: ToastrService,private elearningservice:ElearningService) {
  }
...
//  add category
  ...
  addcategory(){
    ...
    this.questionserveice.add_prime_category(formData).subscribe((res)=>{
     console.log(res);
  ...
  updatecategory(){
     ...
     if(this.UpdateCategory.invalid){
      ...
      const data = {
       ...
       this.questionserveice.update_prime_category(this.category_id,data).subscribe((res)=>{
         if(res){
          console.log(res)
...
// delete category
  ...
  deletecategory(){
    this.questionserveice.delete_prime_category(this.categroy_id).subscribe((res)=>{
      console.log(res)
