...
declare var $:any;
@Component({
  selector: 'app-past-exam-topics',
  templateUrl: './past-exam-topics.component.html',
  styleUrls: ['./past-exam-topics.component.css']
})
export class PastExamTopicsComponent implements OnInit {
...
// all subcategory
  ...
  getallsubcategory(){
    // this.spinner.show();
    this.elearningservice.pastpaper_subcategory_list().subscribe((res)=>{
    if(res){
      // this.spinner.hide();
      console.log(res);
...
// add icards
  ...
  add_icards(){
    ...
    if(this.Icards.invalid){
      ...
      this.elearningservice.add_pastpaper(formData).subscribe((res)=>{
...
// edit icards
  ...
  updateicarde(){ 
   ...
   if(this.UpdateIcards.invalid){
    ...
    formData.append('pdf', this.file);
    console.log(formData)
    this.elearningservice.update_pastpaper(this.icards_id,formData).subscribe((res)=>{
      this.toastr.success(this.message,'Successfully Past paper updated',{
        positionClass: 'toast-top-center'
      });
      $('#editicards').hide();
      this.all_list_icards()
...
// delete icards
  ...
  deleteicards(){
    this.elearningservice.delete_pastpaper(this.icards_id).subscribe((res)=>{
      this.toastr.success(this.message,'Sucessfully Past paper deleted',{
        positionClass: 'toast-top-center'
      });
      $('#deleteicards').hide();
      this.all_list_icards();
