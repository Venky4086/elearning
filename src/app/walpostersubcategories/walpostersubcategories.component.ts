...
@Component({
  selector: 'app-walpostersubcategories',
  templateUrl: './walpostersubcategories.component.html',
  styleUrls: ['./walpostersubcategories.component.css']
})
export class WalpostersubcategoriesComponent implements OnInit {
  ...
  getallcategorys(){
    // this.spinner.show();
    this.elearningservice.wallposter_category_list().subscribe((res)=>{
      if(res){
        // this.spinner.hide();
        console.log(res);
...
// add subcategories
  ...
  addsubcategory(){
    ...
    if(this.Addsubcategory.invalid){
      ...
      console.log(data);
      this.elearningservice.add_wallposter_subcategory(data).subscribe((res)=>{
        if(res){
        console.log(res);
  ...
  updatesubcategory(){
    ...
    if(this.Updatesubcategory.invalid){
      ...
      console.log(data);
      this.elearningservice.update_wallposter_category(this.subcategory_id,data).subscribe((res)=>{
        if(res){
        console.log(res);
  ...
  deletesubcategory(){
    this.elearningservice.delete_wallposter_category(this.subcategory_id).subscribe((res)=>{
      console.log(res);
