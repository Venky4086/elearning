...
@Component({
  selector: 'app-audiocategories',
  templateUrl: './audiocategories.component.html',
  styleUrls: ['./audiocategories.component.css']
})
...
//  add category
  ...
  addcategory(){
    ...
    this.elearningservice.add_audio_category(formData).subscribe((res)=>{
     console.log(res);
  ...
  updatecategory(){
     ...
     if(this.UpdateCategory.invalid){
      ...
      const data = {
       ...
       this.elearningservice.update_audio_category(this.category_id,data).subscribe((res)=>{
         if(res){
          console.log(res)
...
// delete category
  ...
  deletecategory(){
    this.elearningservice.delete_audio_category(this.categroy_id).subscribe((res)=>{
      console.log(res)
