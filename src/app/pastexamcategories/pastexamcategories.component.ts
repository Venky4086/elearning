...
@Component({
  selector: 'app-pastexamcategories',
  templateUrl: './pastexamcategories.component.html',
  styleUrls: ['./pastexamcategories.component.css']
})
export class PastexamcategoriesComponent implements OnInit {
...
//  add category
  ...
  addcategory(){
    ...
    this.elearningservice.add_pastpaper_category(formData).subscribe((res)=>{
     console.log(res);
  ...
  updatecategory(){
     ...
     if(this.UpdateCategory.invalid){
      ...
      const data = {
       ...
       this.elearningservice.update_pastpaper_category(this.category_id,data).subscribe((res)=>{
         if(res){
          console.log(res)
...
// delete category
  ...
  deletecategory(){
    this.elearningservice.delete_pastpaper_category(this.categroy_id).subscribe((res)=>{
      console.log(res)
