...
@Component({
  selector: 'app-previous-qpaperscategory',
  templateUrl: './previous-qpaperscategory.component.html',
  styleUrls: ['./previous-qpaperscategory.component.css']
})
export class PreviousQpaperscategoryComponent implements OnInit {
...
//  add category
  ...
  addcategory(){
    ...
    this.questionservice.add_previous_qpaper_category(formData).subscribe((res)=>{
     console.log(res);
  ...
  updatecategory(){
     ...
     if(this.UpdateCategory.invalid){
      ...
      const data = {
       ...
       this.questionservice.update_previous_qpaper_category(this.category_id,data).subscribe((res)=>{
         if(res){
          console.log(res)
...
// delete category
  ...
  deletecategory(){
    this.questionservice.delete_previous_qpaper_category(this.categroy_id).subscribe((res)=>{
      console.log(res)
