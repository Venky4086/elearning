...
@Component({
  selector: 'app-recentcategories',
  templateUrl: './recentcategories.component.html',
  styleUrls: ['./recentcategories.component.css']
})
export class RecentcategoriesComponent implements OnInit {
...
//  add category
  ...
  addcategory(){
    ...
    this.elearningservice.add_recent_update_category(formData).subscribe((res)=>{
     console.log(res);
  ...
  updatecategory(){
     ...
     if(this.UpdateCategory.invalid){
      ...
      const data = {
       ...
       this.elearningservice.update_recent_update_category(this.category_id,data).subscribe((res)=>{
         if(res){
          console.log(res)
...
// delete category
  ...
  deletecategory(){
    this.elearningservice.delete_recent_update_category(this.categroy_id).subscribe((res)=>{
      console.log(res)
