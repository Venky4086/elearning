...
@Component({
  selector: 'app-valuecategories',
  templateUrl: './valuecategories.component.html',
  styleUrls: ['./valuecategories.component.css']
})
export class ValuecategoriesComponent implements OnInit {
...
//  add category
  ...
  addcategory(){
    ...
    this.elearningservice.add_value_category(formData).subscribe((res)=>{
     console.log(res);
  ...
  updatecategory(){
     ...
     if(this.UpdateCategory.invalid){
      ...
      const data = {
       ...
       this.elearningservice.update_value_category(this.category_id,data).subscribe((res)=>{
         if(res){
          console.log(res)
...
// delete category
  ...
  deletecategory(){
    this.elearningservice.delete_value_category(this.categroy_id).subscribe((res)=>{
      console.log(res)
