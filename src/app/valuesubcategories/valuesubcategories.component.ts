...
@Component({
  selector: 'app-valuesubcategories',
  templateUrl: './valuesubcategories.component.html',
  styleUrls: ['./valuesubcategories.component.css']
})
export class ValuesubcategoriesComponent implements OnInit {
  ...
  getallcategorys(){
    this.spinner.show();
    this.elearningservice.value_category_list().subscribe((res)=>{
      if(res){
        this.spinner.hide();
        console.log(res);
...
// add subcategories
  ...
  addsubcategory(){
    ...
    if(this.Addsubcategory.invalid){
      ...
      console.log(data);
      this.elearningservice.add_value_subcategory(data).subscribe((res)=>{
        if(res){
        console.log(res);
  ...
  updatesubcategory(){
    ...
    if(this.Updatesubcategory.invalid){
      ...
      console.log(data);
      this.elearningservice.update_value_subcategory(this.subcategory_id,data).subscribe((res)=>{
        if(res){
        console.log(res);
  ...
  deletesubcategory(){
    this.elearningservice.delete_value_subcategory(this.subcategory_id).subscribe((res)=>{
      console.log(res);
