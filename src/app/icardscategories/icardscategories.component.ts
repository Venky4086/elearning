...
@Component({
  selector: 'app-icardscategories',
  templateUrl: './icardscategories.component.html',
  styleUrls: ['./icardscategories.component.css']
})
export class IcardscategoriesComponent implements OnInit {
...
//  add category
  ...
  addcategory(){
    ...
    this.elearningservice.add_icard_category(formData).subscribe((res)=>{
     console.log(res);
  ...
  updatecategory(){
     ...
     if(this.UpdateCategory.invalid){
      ...
      const data = {
       ...
       this.elearningservice.update_icard_category(this.category_id,data).subscribe((res)=>{
         if(res){
          console.log(res)
...
// delete category
  ...
  deletecategory(){
    this.elearningservice.delete_icard_category(this.categroy_id).subscribe((res)=>{
      console.log(res)
