...
@Component({
  selector: 'app-audiosubcategories',
  templateUrl: './audiosubcategories.component.html',
  styleUrls: ['./audiosubcategories.component.css']
})
export class AudiosubcategoriesComponent implements OnInit {
  ...
  getallcategorys(){
    // this.spinner.show();
    this.elearningservice.audio_category_list().subscribe((res)=>{
      if(res){
        // this.spinner.hide();
        console.log(res);
...
// add subcategories
  addsubcategory(){
    ...
    if(this.Addsubcategory.invalid){
      ...
      console.log(data);
      this.elearningservice.add_audio_subcategory(data).subscribe((res)=>{
        if(res){
        console.log(res);
  ...
  updatesubcategory(){
    ...
    if(this.Updatesubcategory.invalid){
      ...
      console.log(data);
      this.elearningservice.update_audio_subcategory(this.subcategory_id,data).subscribe((res)=>{
        if(res){
        console.log(res);
  ...
  deletesubcategory(){
    this.elearningservice.delete_audio_subcategory(this.subcategory_id).subscribe((res)=>{
      console.log(res);
