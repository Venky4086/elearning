...
@Component({
  selector: 'app-imagbankcategory',
  templateUrl: './imagbankcategory.component.html',
  styleUrls: ['./imagbankcategory.component.css']
})
export class ImagbankcategoryComponent implements OnInit {
...
//  add category
  ...
  addcategory(){
    ...
    this.elearningservice.add_img_bank_category(formData).subscribe((res)=>{
     console.log(res);
  ...
  updatecategory(){
     ...
     if(this.UpdateCategory.invalid){
      ...
      const data = {
       ...
       this.elearningservice.update_img_bank_category(this.category_id,data).subscribe((res)=>{
         if(res){
          console.log(res)
...
// delete category
  ...
  deletecategory(){
    this.elearningservice.delete_img_bank_category(this.categroy_id).subscribe((res)=>{
      console.log(res)
